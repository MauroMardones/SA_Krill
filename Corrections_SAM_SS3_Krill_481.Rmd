---
title: "FSA Working Report Stock Assessment Krill WAP"
author:
...
This study addresses key recommendations highlighted in the preliminary Report of the Working Group on Statistics, Assessment, and Modelling (WG-SAM-2024) regarding to analysis of integrating diverse information sources for understanding the population dynamics of Antarctic krill (*Euphausia superba*) within an integrated stock assessment model, especially in the face of environmental change and fisheries management challenges. This work systematically incorporates fishing, environmental, and ecological variables while accounting for the spatial heterogeneity of the krill population structure. Additionally, it evaluates the impact of biological and structural assumptions on model performance, calculates the harvest rate, and refines the proposed management procedures in a both conceptual and tactical approach. By acknowledging and integrating these diverse data sources, the model provides valuable insights into krill population dynamics, and continue contributing to the enhancement of CCAMLR fishery management and conservation strategies in the region.
