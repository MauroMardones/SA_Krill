...
diagnostics <- data.frame(
  ...
  Gradient = c(
    base.model1.1$maximum_gradient_component,
    base.model1.2$maximum_gradient_component,
    base.model1.3$maximum_gradient_component,
    base.model1.4$maximum_gradient_component
  ),
  Likelihood = c(
    base.model1.1$likelihoods_used[1,1],
    base.model1.2$likelihoods_used[1,1],
    base.model1.3$likelihoods_used[1,1],
    base.model1.4$likelihoods_used[1,1]
  ),
  Parameters = c(
    dim(base.model1.1$parameters)[1],
    dim(base.model1.2$parameters)[1],
    dim(base.model1.3$parameters)[1],
    dim(base.model1.4$parameters)[1]
  ),
  RMSE = c(
    mean(as.numeric(base.model1.1$index_variance_tuning_check$RMSE)),
    mean(as.numeric(base.model1.2$index_variance_tuning_check$RMSE[1:10])),
    mean(as.numeric(base.model1.3$index_variance_tuning_check$RMSE[1:10])),
    mean(as.numeric(base.model1.4$index_variance_tuning_check$RMSE[1:10]))
  )
)
#write_csv(diagnostics, "model_diagnosis.csv")
flextable(diagnostics) %>%
  set_caption("Diagnostic summary of model scenarios") %>%
  autofit() %>%
  theme_booktabs() %>%
