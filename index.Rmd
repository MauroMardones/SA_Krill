...
dir1.1<-here("s1.1") # con todo
dir1.2 <- here("s1.2") # sin predador ni ambiental
dir1.3 <- here("s1.3") # borrado los registros de prreddador )igual q el S2
Figs <- here("Figs")# S
```
...
|    s1.2  | "s1.1" with environmental and predator components                                    |
|    s1.3  | "s1.2" w/ selectivity blocks                                                         |
...
#read in all model runs
#note if cover=T you need a hessian; if covar=F you do not need a hessian
biglist1_2_3 <- SSgetoutput(keyvec = NULL,
                       dirvec = c(
                                  dir1.1,
                                  dir1.2,
                                  dir1.3),
...
#create summary of model runs from list above
summaryoutput1_2_3 <- SSsummarize(biglist1_2_3)

SSplotComparisons(summaryoutput1_2_3,
