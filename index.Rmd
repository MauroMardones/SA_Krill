...
parInit %>%
  ...
  kbl(booktabs = TRUE,
      ...
      kable_styling(latex_options = "scale_down",  # Expande la tabla al ancho completo
                font_size = 8) %>%  # Aplica la fuente Times New Roman
...
```{r dataserie, fig.width=9, fig.height=7}
