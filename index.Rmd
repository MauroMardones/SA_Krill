...
retroSummary <- SSsummarize(retroModelstest)
...
```{r}
outps1 <- base.model1$timeseries[1:53, 2:8]
...
comp01_1_7 <- SSplotComparisons(summaryoutput01_1_7,
                  legendlabels = c(
                                   "No Spatial",
