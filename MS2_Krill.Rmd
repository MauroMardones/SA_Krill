...
$$
Positive values of (\beta_E) indicate environmental conditions that enhance recruitment, while negative values imply adverse effects. Because the env-link operates multiplicatively, environmental effects scale recruitment exponentially rather than additively. By incorporating environmental forcing through the env-link, part of the interannual variability in krill recruitment that would otherwise be attributed to unexplained recruitment deviations is instead explained by the environmental covariate. Consequently, improved model fit is expected to manifest as a reduction in the estimated recruitment deviation variance (\sigma_R^2), although this reduction is not imposed a priori and arises through likelihood optimization. The inclusion of the selected environmental variable via the env-link framework provides a biologically interpretable and statistically coherent mechanism to integrate ecosystem drivers into the core population dynamics of the krill stock assessment.

To identify the most influential environmental drivers of krill recruitment for use in stock assessment processes, we examined the relationship between a recruitment index and three key environmental variables known to shape krill population dynamics: Sea Surface Temperature (SST), Sea Ice Concentration (SIC), and Chlorophyll-a (Chl-a) [@Flores2012; @Morley2020; @Saba2014; @Veytia2021; @Walsh2020]. Table @ref(tab:env) summarizes the main characteristics of the environmental datasets used in this analysis. These variables were obtained from a combination of satellite and reanalysis products, including *Nimbus-7* [doi.org/10.5067/QOZIVYV3V9JP], *ERA5* [doi.org/10.48670/moi-00021], and the *EU Copernicus Marine Service* [doi.org/10.48670/moi-00148]. The influence of environmental variability on krill recruitment was evaluated using a series of linear models, progressively incorporating environmental covariates to identify those with the greatest explanatory power. The initial model included only spatial structure through management units (MUs), while subsequent models sequentially added Chl-a, SST, SIC, and interaction terms. Results from correlation analyses and linear models (Supporting Information 2) consistently indicated that chlorophyll-a exhibited the strongest relationship with recruitment, outperforming SST and SIC across model configurations. Based on these results, chlorophyll-a was selected as the environmental covariate incorporated into the SS3. 
