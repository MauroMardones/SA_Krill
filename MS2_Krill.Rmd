...
Understanding the drivers of krill (*Euphausia superba*) population dynamics is crucial for sustainable management. This study evaluates the impact of environmental variables and predation components on krill productivity, specifically stock-recruitment relationships and other population parameters, in the Western Antarctic Peninsula. Using an integrated Catch-at-Length model, we assess how ecosystem factors influence recruitment, biomass trends, and stock status.  Our results indicate that krill population variables, as well as productivity estimates, tend to be more optimistic in terms of stock status when environmental and predators variables are not considered. This highlights a critical challenge in developing management recommendations and harvest control rules, as ignoring ecosystem influences may lead to overly optimistic assessments of krill stock health.  Our findings emphasize the necessity of incorporating ecosystem variables into population stock assessments process, as neglecting these factors may lead to biased estimations of krill population dynamics. We consider that the use of integrated models, which leverage the extensive population, fisheries, and ecosystem data available through various scientific programs, can provide valuable insights for management aligned with CCAMLR conservation and harvesting objectives.  


**Keywords:** Antarctic krill, population dynamics, stock-recruitment, ecosystem variables, Catch-to-Length model, environmental factors, predation, fisheries management.  


# INTRODUCTION

Antarctic krill (*Euphausia superba*) is a keystone species in the Antarctic ecosystem and represents one of the largest living populations on the planet in terms of biomass (REF). This species is widely distributed across the Antarctic continental shelf; however, its populations are currently concentrated mainly in the Antarctic Peninsula region (REF). This spatial concentration has heightened scientific interest in understanding the population dynamics of krill, both from an ecological perspective—due to its crucial role as a prey species for whales, penguins, and other marine organisms (REF)—and from an economic standpoint, given the commercial fishing pressure exerted on this resource (REF).  

Recognizing the ecological and economic importance of krill, the Commission for the Conservation of Antarctic Marine Living Resources (CCAMLR) has prioritized conservation and management strategies aimed at ensuring the sustainability of this resource. The primary objective has been to reconcile commercial exploitation with a precautionary approach that safeguards the ecological community dependent on krill (REF). CCAMLR’s management framework relies on sustainable exploitation recommendations based largely on survey data obtained from acoustic biomass estimation campaigns and fisheries monitoring programs (REF). Over time, these efforts have advanced toward integrating multiple sources of information into assessment models that guide decision-making. One such approach is the use of annual yield models, which recommend catch limits based on predefined exploitation thresholds (REF).  

In this study, we integrate multiple sources of biological and fisheries-related data, including estimates of biomass from scientific surveys, fisheries catch data, and biological parameters, to construct a modern stock assessment model that evaluates key population variables and krill productivity. However, contemporary stock assessment models require the incorporation of ecosystem variables—such as environmental conditions and predator-prey interactions—which are essential components of the Antarctic ecosystem and must be considered when modeling krill population dynamics (REF).  

To address these challenges, we integrate environmental information that influences krill population dynamics, as well as data on predator species that are affected by krill population variability. We employ an integrated catch-at-length stock synthesis model to compare different scenarios and assess the impact of ecosystem variability on key productivity indicators, such as recruitment and other critical population variables (REF). By incorporating these ecosystem drivers into our stock assessment approach, we aim to enhance our understanding of krill population fluctuations and improve the scientific basis for sustainable management recommendations.  

Antarctic krill (*Euphausia superba*) plays a fundamental role in the Southern Ocean ecosystem, linking primary production to higher trophic levels, including marine mammals, seabirds, and fish. Krill populations are subject to complex ecological pressures, including environmental variability (e.g., sea ice extent, temperature fluctuations, and primary productivity) and predation from key species such as penguins. In addition, commercial fisheries target krill, further influencing population dynamics.  

Traditional stock assessments primarily rely on fishery-dependent and survey-based data but often overlook ecosystem variables that may significantly impact population structure and productivity. Integrating environmental and biological drivers into stock assessments is essential to improving our understanding of krill dynamics and ensuring robust management strategies.  

This study aims to assess the impact of ecosystem variables, particularly environmental conditions and predation pressure from penguins, on krill productivity and population structure. Using an integrated Catch-to-Length model, we evaluate stock-recruitment relationships and other key population parameters to determine how ecosystem drivers shape krill dynamics.  
...
This study focuses on the Antarctic Peninsula, a region where krill populations exhibit strong variability due to environmental fluctuations and intense predation pressure. Data were obtained from the Commission for the Conservation of Antarctic Marine Living Resources (CCAMLR), including fishery-dependent catch data, scientific surveys, and predator monitoring datasets. Environmental data, such as sea surface temperature (SST), chlorophyll-a concentration, and sea ice extent, were sourced from satellite observations and oceanographic monitoring programs.  

#### **2.2. Catch-to-Length Model Implementation**  
We applied an integrated Catch-to-Length model to estimate krill stock-recruitment relationships and population trends. The model links catch-at-length data with growth, mortality, and recruitment processes while incorporating environmental and predation variables. Key model parameters include:  

- Growth rates based on length-frequency distributions  
- Natural mortality estimates derived from predator consumption data  
- Stock-recruitment functions incorporating environmental predictors  
- Fishery removals as a function of effort and environmental conditions  

#### **2.3. Statistical Analysis and Model Validation**  
Model performance was evaluated through likelihood-based comparisons, sensitivity analyses, and cross-validation against independent survey datasets. We tested multiple scenarios to assess the relative influence of environmental and predation variables on recruitment and biomass dynamics.  
...
This draft presents a formal scientific structure suitable for submission to a peer-reviewed journal. Let me know if you need modifications or additional details! 🚀
