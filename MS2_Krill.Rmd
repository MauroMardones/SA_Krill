...
* **Big summary / importance statement for the science**

  * Expón de manera destacada la importancia científica de tus hallazgos generales.

* **Scientific findings as extension of previous work**

  * Relaciona tus hallazgos con trabajos previos y explica cómo los extienden o complementan.

* **Findings' scientific implications**

  * Detalla las implicancias científicas específicas de los resultados obtenidos.

* **How this engineering will facilitate future research**

  * Explica cómo tu enfoque metodológico o técnico puede ayudar a futuras investigaciones.

* **Forward-looking statements about the field as a whole**

  * Incluye reflexiones sobre cómo evolucionará el campo en general a partir de tu trabajo.

* **A summary / importance of the engineering aspect of the work**

  * Resume la importancia de la parte técnica o de ingeniería de tu estudio.

* **How it facilitates scientific research**

  * Describe cómo tus métodos o resultados facilitan la investigación científica práctica.

* **Limitations of the platform shown with questions that would be unanswered**

  * Reconoce limitaciones del estudio y plantea preguntas que aún quedan por responder.
...
> The three main penguin colonies Adélie, Chinstrap, and Gentoo are central place foragers with diet compositions that are strongly linked to krill abundance and demographic structure, particularly during the breeding season when foraging is spatially and temporally constrained [REF Lukcas!, REF Vicky]. 
