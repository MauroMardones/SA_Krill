...
Like most invertebrates, krill is a species for which aging is complex. Therefore, a size-structured model with age dynamics is used, which is transformed through a transition matrix based on the probabilities of age groups relative to the detailed structure. Despite this, integrated models have the capacity to reproduce the age dynamics of these populations and simultaneously transform them into population variables.
...
@Kinzey2015a, @Kinzey2011 and @Kinzey2019a used integrated models with fishery and survey data to test the impacts of selectivity and recruitment estimation in certain areas of Subarea 48.1. Additionally, @Wang2021 made significant contributions to integrated statistical models for the northern sector of the Western Antarctic Peninsula, focusing on the Bransfield Strait, testing different data weightings. Furthermore, examined correlations between recruitment and climatic variables such as the Southern Annular Mode (SAM) and El Niño.


Wang..
Lo que es nuevo aca es

**Paragraph 3:**  
From an ecological standpoint, the study area encompasses the primary spawning, breeding, and wintering regions of Antarctic krill in the southwest Atlantic Ocean. In terms of the krill fishery, this area includes a significant fishing ground, specifically subarea 48.1. Notably, recent years have seen a higher concentration of krill catches in this subarea, both temporally and spatially.
