...
```{r AKL, out.width='60%',  fig.cap="ALK Matrix Heatmap to krill in 48.1}
...
```{r path, out.width='70%', fig.cap="Framework path to stock assessment model in krill in WAP (Yellow boxes is not implemeted yet)."}
