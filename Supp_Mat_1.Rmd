...
plot_selex_scenario(base.model1.6, "s1.6")
plot_selex_scenario(base.model1.7, "s1.7")
```
...
#plot_indices_scenario(base.model1.5, "s1.5")
plot_indices_scenario(base.model1.6, "s1.6")
plot_indices_scenario(base.model1.7, "s1.7")
```
...
```{r biasramp, eval=FALSE, warning=FALSE, message=FALSE, fig.cap="Bias correction by scenario"}}
...
```{r rmse1, fig.height=8, fig.width=12, fig.cap="Time series of RMSE of length compositions by scenario"}
par(mfrow=c(2,4), mar=c(5,4,2,1))
...
```{r rmse2, fig.height=8, fig.width=12, fig.cap="Time series of RMSE of CPUE compositions by scenario"}
par(mfrow=c(2,4), mar=c(5,4,2,1))
...
difrmse <- ggplot(combined_rmse_delta, aes(x = Scenario, y = Delta, fill = Scenario)) +
  ...
  theme(legend.position = "none", strip.background = element_blank(),
        panel.grid.minor = element_blank()) +
  coord_flip(ylim = c(-12, 12))   # amplié un poco el límite inferior para que quepa s1.2
