...
acf_combined <- cowplot::plot_grid(p1, p2, p3, p4, ncol = 2)
...
combined_rmse_delta <- combined_rmse |>
  ...
  mutate(Metric = dplyr::recode(Metric,
         ...
         Scenario = factor(Scenario, levels = c("s1.2", "s1.3", "s1.4")))
...
difrmse <- ggplot(combined_rmse_delta, aes(x = Scenario, y = Delta, fill = Scenario)) +
  ...
  facet_wrap(~Metric) +
  scale_fill_manual(values = c("s1.2" = "#f4a582", "s1.3" = "#bababa", "s1.4" = "#404040")) +
