...
0.01 0.5 0.2 0.1 0.8 0 3 0 5 1992 2020 2 0 0 # M2_pred1
...
3            30           23         23            10              0          1          1          1          2000          2020          0          0          0 # SR_LN(R0)
...
1971.5   #_last_early_yr_nobias_adj_in_MPD 
1998.9   #_first_yr_fullbias_adj_in_MPD 
1999.9   #_last_yr_fullbias_adj_in_MPD 
2000.0   #_first_recent_yr_nobias_adj_in_MPD 
0.8246  #_max_bias_adj_in_MPD (1.0 to mimic pre-2009 models) 
...
-7	25	-5	0	1	0	-1	0	0	0	0	0	0	0	#	LnQ_base_PREDATOR(11)
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
#	1	FISHERY	LenSelex														
0.01	8	2	2	0.01	1	-3	1          1          2000          2020          0          1          1	#	Size_inflection_FISHERY(1)		
  0	8	2	2	0.01	1	-2	0	0	0	0	0	1	1	#	Size_95%width_FISHERY(1)		
#	1	FISHERY	LenSelex														
  0.01	8 3.5	3.5	0.01	1	-3	1	0	0	0	0	1	1	#	Size_inflection_FISHERY(2)		
  0	8	4	4	0.01	1	-2	0	0	0	0	0	1	1	#	Size_95%width_FISHERY(2)		
#	1	FISHERY	LenSelex														
  0.01	8	2	2	0.01	1	-3	1	0	0	0	0	0	0	#	Size_inflection_FISHERY(3)		
  0	8	2	2	0.01	1	2	0	0	0	0	0	0	0	#	Size_95%width_FISHERY(3)	
#	1	FISHERY	LenSelex														
  0.01	8	3.5	3.5	0.01	1	-3	1	0	0	0	0	1	1	#	Size_inflection_FISHERY(4)		
  0	8	2	2	0.01	1	-2	0	0	0	0	0	1	1	#	Size_95%width_FISHERY(4)	
#	1	FISHERY	LenSelex														
  0.01	8	3.5	3.5	0.01	1	-3	1	0	0	0	0	1	1	#	Size_inflection_FISHERY(5)		
